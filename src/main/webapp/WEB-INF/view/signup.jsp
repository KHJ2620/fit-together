		...
		<div class="wrap-sm">
			...
			<c:if test="${param.error != null }">
				...
				style="background-color: lightcoral; color: white">
					회원가입에 실패하였습니다. 다시 시도하세요.
				
				</div>
			</c:if>
			<form
				action="${pageContext.servletContext.contextPath }/signup-handle" method="post">
				<div>
					<label class="fs-3">계정아이디<span class="warning">(*)</span></label>
					<div class="my-1">
						<input type="text" placeholder="아이디.." class="w-100 p-1 fs-4  border-rounded " 
							name="id" />
					</div>
				</div>
				<div>
				...
				<div>
					...
					<div class="my-1">
						<input type="text" placeholder="사용자 이름.." class="w-100 p-1 fs-4  border-rounded "
							name="name" />
					</div>
				</div>
				<div>
					...
					<div class="my-1">
						<input type="text" placeholder="이메일.." class="w-100 p-1 fs-4  border-rounded "
							name="email" />
					</div>
				</div>
				<div>
